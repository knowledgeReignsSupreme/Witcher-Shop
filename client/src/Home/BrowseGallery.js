...
const BrowseGallery = () => {
  return (
    <StyledBrowse>
      <Heading>
        <h2>Browse</h2>
        <a href='/shop/category/all/sort/title/page/1'>Browse all &rarr;</a>
      </Heading>
      <Categories>
        <Category>
          <Link to='/shop/category/silver-swords/sort/title/page/1'>
            <img src={silverSword} alt='silver sword' />
            <p>Silver swords</p>
          </Link>
        </Category>
        <Category>
          <Link to='/shop/category/steel-swords/sort/title/page/1'>
            <img src={steelSword} alt='steel sword' />
            <p>Steel swords</p>
          </Link>
        </Category>
        <Category>
          <Link to='/shop/category/armors/sort/title/page/1'>
            <img src={armor} alt='armor' />
            <p>Armors</p>
          </Link>
        </Category>
        <Category>
          <Link to='/shop/category/potions/sort/title/page/1'>
